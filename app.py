    ...
    if submit_button and draw_query:
        ...
        with st.chat_message("assistant"):
            with st.spinner("سمسمة تترجم وترسم لكِ عبر سيرفر كروك الصاروخي... 🚀"):
                try:
                    # الخطوة الأولى: الترجمة الفورية المتوافقة 100% مع مخرجات لاما 4 لمنع الخطأ الوردي
                    ...
                    # التصحيح البرمجي النهائي لفك قائمة استجابة لاما 4 بأمان وبدون أخطاء
                    ...
                    # الخطوة الثانية: استدعاء التوليد البرمجي عبر مكتبة Groq الرسمية
                    ...
                    # جلب رابط التحميل المؤقت للصورة
